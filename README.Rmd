...
The package also provides a convenience function to download the full IDS data pre-processed with `wbids` from the corresponding EconDataverse dataset on [Hugging Face](https://huggingface.co/datasets/econdataverse/wbids) via the [`econdatasets`](https://tidy-intelligence.github.io/r-econdatasets/) package: 
